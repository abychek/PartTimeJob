...
(function() {
  ...
  function SailsIOClient(io) {
    ...
    io.sails.connect = function(url, opts) {
      ...
      // Instantiate and return a createForm SailsSocket- and try to connect immediately.
