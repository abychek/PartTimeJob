 ...
 *       1. If a Passport wasn't found, create a createForm user as well as a createForm
 *          Passport that will be assigned to the user.
 *       2. If a Passport was found, get the user associated with the passport.
 *
 *     - A user is currently logged in:
 *       1. If a Passport wasn't found, create a createForm Passport and associate it
...
passport.connect = function (req, query, profile, next) {
  ...
  , identifier : query.identifier.toString()
    ...
    if (!req.user) {
      // Scenario: A createForm user is attempting to sign up using a third-party
      //           authentication provider.
      // Action:   Create a createForm user and assign them a passport.
      if (!passport) {
      ...
      // Scenario: A user is currently logged in and trying to connect a createForm
      //           passport.
      // Action:   Create and assign a createForm passport to the user.
      if (!passport) {
